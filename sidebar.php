<div class="agenda">
	<div class="titulo-noticias">
		<h2>Agenda</h2>
		<a href="<?php bloginfo('url'); ?>/agenda">Ver más</a>
	</div>
	...
	<div class="caja-agenda">
        ...
        $currentPage = (get_query_var('paged')) ? get_query_var('paged') : 1 ; //cuenta el numero de post y si no existen vuelve a la primera pagina
            ...
            $the_query_sidebar = new WP_Query( $args2 );    
    		?>
			<?php if ( have_posts() ) : while ( $the_query_sidebar->have_posts() ) : $the_query_sidebar->the_post(); ?>
